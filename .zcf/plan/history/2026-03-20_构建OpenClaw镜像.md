...
### 阶段 1：创建 openclaw 模块目录结构
- [x] 创建模块根目录和子目录
- [x] 创建 versions.yaml 版本配置文件

### 阶段 2：编写 Dockerfile 文件
- [x] 创建主 Dockerfile（Ubuntu 24.04）
- [x] 创建 Ubuntu 22.04 变体 Dockerfile
- [x] 创建 Debian Bookworm 变体 Dockerfile

### 阶段 3：编写脚本文件
- [x] 创建 entrypoint.sh 启动脚本
- [x] 创建 healthcheck.sh 健康检查脚本
- [x] 创建 download-latest.sh 版本下载脚本
- [x] 创建 install-tools.sh 工具安装脚本

### 阶段 4：创建配置文件
- [x] 创建 openclaw.default.conf 默认配置
- [x] 创建 docker-compose.yml 本地开发配置

### 阶段 5：创建 GitHub Actions 工作流
- [x] 创建 build-openclaw.yml 构建工作流

### 阶段 6：更新项目文档
- [x] 创建 openclaw/README.md
- [x] 创建 openclaw/CLAUDE.md
- [x] 更新根级 CLAUDE.md
